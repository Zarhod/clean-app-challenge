...
// Fonction pour calculer le récapitulatif de la semaine précédente (déplacée ici pour éviter le warning no-use-before-define)
const calculateWeeklyRecap = (userId, displayName, allRealisations, allHistoricalPodiums) => {
